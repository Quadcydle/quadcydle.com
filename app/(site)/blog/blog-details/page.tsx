        ...
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
          <div className="flex flex-col-reverse gap-7.5 lg:flex-row xl:gap-12.5">
            <div className="md:w-1/2 lg:w-[32%]">
              <div className="animate_top mb-10 rounded-md border border-stroke bg-transparent p-3.5 shadow-solid-13 dark:border-strokedark dark:bg-blacksection">
                <form
                ...
                >
                  <div className="relative">
                    ...
                    >
                      <svg
                        className="fill-black transition-all duration-300 hover:fill-primary dark:fill-transparent dark:hover:fill-primary"
                        width="21"
                        height="21"
                        viewBox="0 0 21 21"
                        fill="none"
              ...
              <div className="animate_top mb-10 rounded-md border border-stroke bg-transparent p-9 shadow-solid-13 dark:border-strokedark dark:bg-blacksection">
            ...
            <div className="lg:w-2/3">
              <div className="animate_top rounded-md border border-stroke bg-transparent p-7.5 shadow-solid-13 dark:border-strokedark dark:bg-blacksection md:p-10">
